...
dashboard = Window(
    ...
    SwitchTo(I18nFormat("btn-admin.schedule"), id="new_rasp", state=AdminDashboard.SCHEDULE),
    SwitchTo(I18nFormat("btn-admin.photo"), id="photo_add", state=AdminDashboard.ADD_YEAR_PHOTO),
...
add_schedule = Window(
    ...
    SwitchTo(I18nFormat("btn-back.common"), id="back", state=AdminDashboard.MAIN),
...
router = Dialog(dashboard, add_schedule, add_photo)
